  ...
  return (
    <div className="flex h-full flex-col" data-slot="week-view">
      ...
      <div className="flex-1 overflow-y-auto scrollbar-thin scrollbar-thumb-muted scrollbar-track-transparent">
        <div className="grid grid-cols-8 border-border border-b">
          <div className="grid auto-cols-fr border-border border-r bg-background sticky left-0 z-20">
            {hours.map((hour, index) => (
              <div
                className="relative min-h-[var(--week-cells-height)] border-border border-b last:border-b-0"
                key={hour.toString()}>
                {index > 0 && (
                  <span
          ...
          {days.map((day, dayIndex) => (
            <div
              className="relative grid auto-cols-fr border-border border-r last:border-r-0"
              data-today={isToday(day) || undefined}
              key={day.toString()}>
              {/* Positioned events */}
